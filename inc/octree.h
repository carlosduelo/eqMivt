...
class Octree
{
	...
	public:
		...
		void getBoxIntersected(eq::Vector4f origin, eq::Vector4f  LB, eq::Vector4f up, eq::Vector4f right, float w, float h, int pvpW, int pvpH, eq::Vector2f jitter, visibleCube_t * visibleGPU, visibleCube_t * visibleCPU, cudaStream_t stream);
